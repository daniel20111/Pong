...
namespace Pong
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            // Draw Walls & Goals
            spriteBatch.Draw(t_wall, boundingBoxTop, boundingBoxTop, Color.Black);
            spriteBatch.Draw(t_wall, boundingBoxBottom, boundingBoxBottom, Color.Black);

            spriteBatch.Draw(t_goal, boundingBoxLeft, boundingBoxLeft, Color.Black);
            spriteBatch.Draw(t_goal, boundingBoxRight, boundingBoxRight, Color.Black);
            ...
            // Draw Text
            string text = "Puntuacion: " + player1.Score + ":" + player2.Score;
